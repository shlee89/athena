package org.onosproject.provider.framework.abnormal.trigger.impl;
...
public class TriggerHelperProvider extends AbstractProvider
        implements org.onosproject.athena.trigger.TriggerHelperProvider {
    ...
    @Reference(cardinality = ReferenceCardinality.MANDATORY_UNARY)
    protected TriggerHelperProviderRegistry providerRegistry;

    private TriggerHelperProviderService providerService;

    protected InternalFeatureCollector listener = new InternalFeatureCollector();

    public TriggerHelperProvider() {
