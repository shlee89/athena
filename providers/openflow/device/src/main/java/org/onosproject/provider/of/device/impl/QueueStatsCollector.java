 ...
 */
public class QueueStatsCollector implements TimerTask {
     ...
     */
    public QueueStatsCollector(OpenFlowSwitch sw, int interval) {
        this.sw = sw;
    ...
    public void run(Timeout to) throws Exception {
        ...
        log.trace("Collecting Queue stats for {}", sw.getStringId());
    ...
    public synchronized void start() {
        log.info("Starting Queue Stats collection thread for {}", sw.getStringId());
        stopped = false;
    ...
    public synchronized void stop() {
        log.info("Stopping Queue Stats collection thread for {}", sw.getStringId());
        stopped = true;
        timeout.cancel();
    }
}
