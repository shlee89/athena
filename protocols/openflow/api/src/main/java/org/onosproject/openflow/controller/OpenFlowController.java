...
public interface OpenFlowController {
    ...
    /**
     * Register a listener for Statistics events.
     *
     * @param priority the importance of this listener, lower values are more important
     * @param listener the listener to notify
     */
    void addStatisticsListener(int priority, OpenFlowStatisticsListener listener);
     ...
     * @param listener the listener to unregister.
     */
    void removeStatisticsListener(OpenFlowStatisticsListener listener);

    /**
     * Register a listener for asynchronous events.
     * @param priority the importance of this listener, lower values are more important
     * @param listener the listener to notify
     */
    void addAsynchronousListener(int priority, OpenFlowAsynchronousEventListener listener);
     ...
     * @param listener the listener to unregister
     */
    void removeAsynchronousListener(OpenFlowAsynchronousEventListener listener);
}
