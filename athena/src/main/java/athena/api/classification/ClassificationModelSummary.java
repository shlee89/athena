 ...
 */
public class ClassificationModelSummary implements Serializable, Summary {
    ...
    public ClassificationModelSummary(SparkContext sc, Indexing indexing, Marking marking) {
    ...
    public ClassificationModelSummary(SparkContext sc, Indexing indexing) {
        this.indexing = indexing;
        this.initializeVariables(sc);

    }

    public ClassificationModelSummary(SparkContext sc) {
        this.initializeVariables(sc);
