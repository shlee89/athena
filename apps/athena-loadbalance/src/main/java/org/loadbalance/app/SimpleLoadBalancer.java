...
public class SimpleLoadBalancer {
    ...
    private LoadbalancerPacketProcessor processor = new LoadbalancerPacketProcessor();
...
//    private DeviceId houston = DeviceId.deviceId("of:0000000000000008");
    private List<DeviceId> pathForGateway1;
    private List<DeviceId> pathForGateway2;
    private List<DeviceId> coreSwitches;
...
//    private HostId webserver2 = HostId.hostId("D2:B2:87:4F:6D:04/-1");
    ...
    protected void activate() {
        appId = coreService.registerApplication("org.onosproject.loadbalancer");
        pathForGateway1 = new ArrayList<DeviceId>();
        pathForGateway1.add(DeviceId.deviceId("of:0000000000000001"));
        pathForGateway1.add(DeviceId.deviceId("of:0000000000000002"));
        pathForGateway1.add(DeviceId.deviceId("of:0000000000000003"));
        pathForGateway1.add(DeviceId.deviceId("of:0000000000000004"));
        pathForGateway1.add(DeviceId.deviceId("of:0000000000000008"));
        pathForGateway2 = new ArrayList<DeviceId>();
        pathForGateway2.add(DeviceId.deviceId("of:0000000000000005"));
        pathForGateway2.add(DeviceId.deviceId("of:0000000000000006"));
        pathForGateway2.add(DeviceId.deviceId("of:0000000000000007"));
        pathForGateway2.add(DeviceId.deviceId("of:0000000000000008"));
        coreSwitches = new ArrayList<DeviceId>();
        coreSwitches.add(DeviceId.deviceId("of:0000000000000002"));
        coreSwitches.add(DeviceId.deviceId("of:0000000000000006"));
 ...
 // clean all flow rules which have destination address of ftpserver of
     ...
     */
    private class LoadbalancerPacketProcessor implements PacketProcessor {
        ...
        public void process(PacketContext context) {
            ...
            // By Jinwoo
            // if the source or the destination is not ftpserver or webserver, return.
